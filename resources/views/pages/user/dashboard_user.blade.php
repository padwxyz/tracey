...
@section('container')
    <section class="pl-24 pr-20 my-10 ml-56 flex-grow">
        ...
        <div class="mt-10">
            <h2 class="text-3xl font-semibold mb-6">Top 5 Recent Activities</h2>
                        ...
                        @foreach ($recentActivities as $activity)
                            <li class="mb-5">
                                <a href="{{ route('activity-details', ['id' => $activity->id]) }}"
                                    ...
                                    <div
                                        class="w-[130px] h-[40px] py-2 px-4 rounded-2xl flex justify-center items-center text-white
